...
%%%%
%% Pour produire le GIF, on va dans l'invite de commandes:
%%
%% convert_magick -density 1000 -delay 200 -loop 0 -alpha remove simplify_line.pdf simplify_line.gif
%%
%% J'ai du changer le nom de la commande convert d'IMageMagick car il y a une fonction Windows qui porte le même nom
%%
%%%%
