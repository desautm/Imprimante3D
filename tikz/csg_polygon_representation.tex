...
\node[oper] {$\setminus$}
child {node[drawing,yshift=-1.5cm,xshift=-1.5cm] {\ConvexHull{3}}}
child {node[drawing,yshift=-1.5cm,xshift=1.5cm] {\Trous{3}}}
;
\end{tikzpicture}
...
\node[oper] {$\setminus$}
child {node[drawing,yshift=-1.5cm,xshift=-1.5cm] {\ConvexHull{3}}}
child {node[oper,yshift=-2cm] {$\cap$}
	child {node[drawing,yshift=-2cm,xshift=-1.5cm] {\TrousBUN{3}}}
	child {node[drawing,yshift=-2cm,xshift=1.5cm] {\Trous{3}}}
}
;
\end{tikzpicture}
