...
# Étape 1 : Est-ce qu'un triangle croise le plan?
...
![](https://media.giphy.com/media/ccAuVsSPSLrDq/giphy.gif)
...
- Un quadtree ou arbre quaternaire (arbre Q) est une structure de données de type arbre dans laquelle chaque noeud a quatre fils. 

- Les quadtrees sont le plus souvent utilisés pour partitionner un espace bidimensionnel en le subdivisant récursivement en quatre noeuds.
